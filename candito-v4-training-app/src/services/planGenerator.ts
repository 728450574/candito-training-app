...
export function buildWeek6TestDays(oneRM: OneRM, rounding: number, assistance: Cycle['assistanceConfig'], startDate: string): TrainingDay[] {
  const offsets = [0, 2, 4]
